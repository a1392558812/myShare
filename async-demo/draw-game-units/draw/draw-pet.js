...
const IDLE_FRAMES = [
  ...
  [{ pixels: [
    // 左眼闭合（覆盖为身体颜色）
    [5, 6, DRAGON_COLORS.body], [6, 6, DRAGON_COLORS.bodyLight],
    [5, 7, DRAGON_COLORS.body], [6, 7, DRAGON_COLORS.bodyLight],
    // 右眼闭合
    [9, 6, DRAGON_COLORS.bodyLight], [10, 6, DRAGON_COLORS.body],
    [9, 7, DRAGON_COLORS.bodyLight], [10, 7, DRAGON_COLORS.body],
    // 眨眼时眼睛高光去除
    [5, 6, DRAGON_COLORS.bodyLight], [6, 6, DRAGON_COLORS.bodyLight],
    [9, 6, DRAGON_COLORS.bodyLight], [10, 6, DRAGON_COLORS.bodyLight],
    // 呼吸 - 身体下边缘微扩张
    [4, 11, DRAGON_COLORS.bodyLight], [11, 11, DRAGON_COLORS.bodyLight],
  ]}],
  ...
  [{ pixels: [
    // 尾巴摆动 - 尾巴向上偏移
    [0, 11, DRAGON_COLORS.finDark], [1, 11, DRAGON_COLORS.fin],
    [0, 12, DRAGON_COLORS.fin], [1, 12, DRAGON_COLORS.finLight],
    [0, 13, DRAGON_COLORS.finDark], [1, 13, DRAGON_COLORS.tailTip], [2, 13, DRAGON_COLORS.tailTip],
    [0, 14, DRAGON_COLORS.fin], [1, 14, DRAGON_COLORS.tailTip],
    [2, 15, DRAGON_COLORS.finDark],
    // 闪光粒子 - 围绕头部漂浮
    [3, 1, DRAGON_COLORS.sparkle],
    [12, 2, DRAGON_COLORS.sparkle],
    [1, 8, DRAGON_COLORS.highlight],
    [14, 9, DRAGON_COLORS.highlight],
  ]}],
];
