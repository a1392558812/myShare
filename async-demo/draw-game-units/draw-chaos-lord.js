 ...
 * @param {Object} currentUnit 混沌领主位置和状态
 * @param {Number} currentUnit.x 混沌领主x坐标
 * @param {Number} currentUnit.y 混沌领主y坐标
 * @param {Number} currentUnit.size 混沌领主大小(px)
...
export const drawChaosLord = (canvasRef, currentUnit) => {
  if (!canvasRef) return
