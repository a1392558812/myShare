    ...
    errorCaptured(error) {
      ...
      switch (error.name) {
        ...
        case "NotFoundError":
          ...
          console.log('There is no connected camera.')
          break;
        case "NotSupportedError":
          this.errorMessage =
            "Seems like this page is served in non-secure context.";
          console.log('Seems like this page is served in non-secure context.')
          break;
        ...
        case "OverconstrainedError":
          ...
          console.log('Constraints don\'t match any installed camera.')
          break;
        default:
