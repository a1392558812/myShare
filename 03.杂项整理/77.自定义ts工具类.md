...
## vue3中，从props提取PropsTypes类型

> [ExtractPropTypes](https://cn.vuejs.org/api/utility-types.html#extractproptypes)
> [ExtractPublicPropTypes](https://cn.vuejs.org/api/utility-types.html#extractpublicproptypes)
> [defineProps](https://cn.vuejs.org/api/sfc-script-setup.html#defineprops-defineemits)
...
type Props1 = ExtractPropTypes<typeof propsOptions>;
// {
//   foo?: string,
//   bar: boolean,
//   baz: number,
